...
ACPOFIExtendedFeatures::getFunctionFeatures(Function &F, DominatorTree &DomTree,
                                            TargetTransformInfo &TTI,
                                            LoopInfo &LI,
                                            FunctionAnalysisManager &FAM,
                                            bool ValidSize, bool ValidLoop,
                                            bool ValidTree) {
...
void runAndDump(raw_fd_ostream &OS, Function *F, DominatorTree &DomTree,
                ...
                CallHeight *CH, FunctionAnalysisManager &FAM) {
...
llvm::operator++(ACPOFIExtendedFeatures::NamedFloatFeatureIndex &n) {
  return n = static_cast<ACPOFIExtendedFeatures::NamedFloatFeatureIndex>(
             (int)n + 1);
}
