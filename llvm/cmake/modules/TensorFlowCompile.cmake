...
function(tf_find_and_compile model default_url default_path test_model_generator tag_set signature_def_key fname cpp_class)
  message(STATUS "tf_find_and_compile " ${model})
  message(STATUS "tf_find_and_compile " ${default_url})
  message(STATUS "tf_find_and_compile " ${default_path})
  message(STATUS "tf_find_and_compile " ${test_model_generator})
  message(STATUS "tf_find_and_compile " ${tag_set})
  message(STATUS "tf_find_and_compile " ${signature_def_key})
  message(STATUS "tf_find_and_compile " ${fname})
  message(STATUS "tf_find_and_compile " ${cpp_class})
  ...
  message(STATUS "tf_find_and_compile " ${override_header})
  message(STATUS "tf_find_and_compile " ${override_object})
