...
#ifndef TFCOMPILE_GENERATED__xla_IR2SCOREIR2VECCompiledModel_AARCH64_llvm_IR2SCOREIR2VECCompiledModel_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED__xla_IR2SCOREIR2VECCompiledModel_AARCH64_llvm_IR2SCOREIR2VECCompiledModel_H_  // NOLINT(build/header_guard)
...
extern "C" void _xla_IR2SCOREIR2VECCompiledModel_AARCH64_llvm_IR2SCOREIR2VECCompiledModel(
...
// IR2SCOREIR2VECCompiledModel represents a computation previously specified in a
...
//
//   IR2SCOREIR2VECCompiledModel computation;
...
class IR2SCOREIR2VECCompiledModel final : public tensorflow::XlaCompiledCpuFunction {
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      set_static_data_raw_function(data, _xla_IR2SCOREIR2VECCompiledModel_AARCH64_llvm_IR2SCOREIR2VECCompiledModel);
  ...
  IR2SCOREIR2VECCompiledModel(AllocMode alloc_mode =
            AllocMode::ARGS_VARIABLES_RESULTS_PROFILES_AND_TEMPS)
      : XlaCompiledCpuFunction(StaticData(), alloc_mode) {}

  IR2SCOREIR2VECCompiledModel(const IR2SCOREIR2VECCompiledModel&) = delete;
  IR2SCOREIR2VECCompiledModel& operator=(const IR2SCOREIR2VECCompiledModel&) = delete;
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{8388608ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{4915200ULL, ~0U, ~0U}),
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{24577ULL, ~0U, ~0U})
      };
    return kBufferInfos;
  }
...
#endif  // TFCOMPILE_GENERATED__xla_IR2SCOREIR2VECCompiledModel_AARCH64_llvm_IR2SCOREIR2VECCompiledModel_H_
