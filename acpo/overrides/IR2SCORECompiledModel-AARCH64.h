...
#ifndef TFCOMPILE_GENERATED__xla_IR2SCORECompiledModel_llvm_IR2SCORECompiledModel_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED__xla_IR2SCORECompiledModel_llvm_IR2SCORECompiledModel_H_  // NOLINT(build/header_guard)
...
extern "C" void _xla_IR2SCORECompiledModel_llvm_IR2SCORECompiledModel(
...
// IR2SCORECompiledModel represents a computation previously specified in a
...
//
//   IR2SCORECompiledModel computation;
...
//   (arg0: f32[1,300]) -> (f32[1,1])
//
// Memory stats:
//   arg bytes total:    1200
//   arg bytes aligned:  1216
//   temp bytes total:   1612
//   temp bytes aligned: 1728
class IR2SCORECompiledModel final : public tensorflow::XlaCompiledCpuFunction {
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      set_static_data_raw_function(data, _xla_IR2SCORECompiledModel_llvm_IR2SCORECompiledModel);
  ...
  IR2SCORECompiledModel(AllocMode alloc_mode =
            AllocMode::ARGS_VARIABLES_RESULTS_PROFILES_AND_TEMPS)
      : XlaCompiledCpuFunction(StaticData(), alloc_mode) {}

  IR2SCORECompiledModel(const IR2SCORECompiledModel&) = delete;
  IR2SCORECompiledModel& operator=(const IR2SCORECompiledModel&) = delete;
  ...
  float& arg0(size_t dim0, size_t dim1) {
    return (*static_cast<float(*)[1][300]>(
  ...
  const float& arg0(size_t dim0, size_t dim1) const {
    return (*static_cast<const float(*)[1][300]>(
        arg_data(0)))[dim0][dim1];
  }
  int arg0_size() const {
    return 300 * sizeof(float);
  }
  ...
  float* arg_feed_x_data() {
    return static_cast<float*>(arg_data(0));
  }
  float& arg_feed_x(size_t dim0, size_t dim1) {
    return (*static_cast<float(*)[1][300]>(
        arg_data(0)))[dim0][dim1];
  }
  const float* arg_feed_x_data() const {
    return static_cast<const float*>(arg_data(0));
  }
  const float& arg_feed_x(size_t dim0, size_t dim1) const {
    return (*static_cast<const float(*)[1][300]>(
        arg_data(0)))[dim0][dim1];
  }
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{1440000ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{480000ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{80000ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{24000ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{4800ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{4802ULL, 0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{1600ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{800ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{480ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{480ULL, ~0U, ~0U}),
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{6401ULL, ~0U, ~0U})
      };
    return kBufferInfos;
  }
...
#endif  // TFCOMPILE_GENERATED__xla_IR2SCORECompiledModel_llvm_IR2SCORECompiledModel_H_
